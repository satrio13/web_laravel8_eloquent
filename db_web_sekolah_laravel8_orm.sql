...
--
-- Database: `db_web_sekolah_laravel8_orm`
--
...
(2, 'Contoh Surat Pernyataan Tidak Pernah Tinggal Kelas', '1708323008_1706939959_5606572e44ad7b90ccd0.docx', 2, 1, '1', '2024-02-18 23:10:08', '2024-02-24 09:02:12');
...
(1, 3, '1708674913_YcOR2T8VO8VfgtR1FhSFDl3IwbgEEUqoa9EBlW2n.jpg', '2024-02-23 07:55:13', '2024-02-23 07:55:13'),
(2, 3, '1708674913_cUI4S0CZPIfDAO5l8TqC3Rj8OrzpJ6UGOzA9U1nL.jpg', '2024-02-23 07:55:13', '2024-02-23 07:55:13');
...
(1, 'Hayabusa', '2020', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'kesan', '1708764542_bngwozejheHODCj06WayE4e4D36c85x6Qp4Jk6MZ.png', '1', '2024-02-24 08:49:02', '2024-02-24 08:49:57'),
(2, 'Hanzo', '2021', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '1708774769_pchbGlFeVn69L9dNFtrpTzMHztka3XiqO8lhBkTq.png', '1', '2024-02-24 11:39:29', '2024-02-25 07:14:28');
...
(1, '1708856216_1708322148_01_Kaldik_dan_Minggu_Efektif_-_Copy.pdf', '2024-02-23 07:18:51', '2024-02-25 10:16:56');
...
(1, NULL, NULL, NULL, NULL, NULL, '-', 'GTT', 'Dani', 'Jakarta', '1990-10-10', NULL, NULL, '1', '1', NULL, NULL, NULL, NULL, NULL, '', 'Aktif', NULL, NULL, '2024-02-17 01:41:35', '2024-02-17 01:41:35');
...
(4, 'Perpustakaan Digital MTs N 1 Kebumen', 'http://pustaka.mtsn1kebumen.sch.id/', '1', '2024-02-20 01:10:11', '2024-02-25 06:33:34');
...
(2, 'Sarwan', '3', 'tes pengaduan', '2024-02-24 09:09:15', '2024-02-24 09:09:15');
...
CREATE TABLE `tb_profil` (
  ...
  `gambar` varchar(250) COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(1, 'MTs NEGERI 1 KEBUMEN', '3', '1708855418_CqAMFrSg5YqsNvGnGak4cfZIbOpQ5aYKiwkdrUVt.jpg', '1708855429_1yUqhJ1bW1gRteBsOMXSCfUJQoZRLuc6CbtrfUEE.png', '1708855425_EVNNbNX9WzPuMPphY4QjWhDDnTy5rF7zciN11oTy.ico', 'Selamat datang di website MTs NEGERI 1 KEBUMEN', 'MTs NEGERI 1 KEBUMEN', NULL, 'Jl. Tentara Pelajar No 29 Kebumen 54312', 'mtsnkebumen1@kemenag.go.id', '(0287) 3812291', '-', NULL, 'A', 'Kurikulum 2013', '', '-', '-', 'https://www.instagram.com/mtsn1kebumen', 'https://web.facebook.com/profile.php?id=100067035564396', 'https://mobile.twitter.com/kebumen_1', 'https://www.youtube.com/channel/UCp_1yWIfzQ1i-tEW06BHhrA', '', '2024-02-23 07:19:07', '2024-02-25 10:04:04');
...
(1, '<br>', '2024-02-23 07:19:14', '2024-02-25 07:02:03');
...
(1, '127.0.0.1', '2024-02-23', 74, '1708695022'),
(2, '127.0.0.1', '2024-02-24', 50, '1708776925'),
(3, '127.0.0.1', '2024-02-25', 11, '1708856688');
...
(1, '1708855717_AvATPHbdFlfeBKkgqeJLsSuoFyXAV96wKC4KvtNI.png', '2024-02-23 07:19:30', '2024-02-25 10:08:37');
...
(1, '2019/2020', '2024-02-23 07:33:25', '2024-02-23 07:33:25'),
(2, '2020/2021', '2024-02-23 07:33:25', '2024-02-23 07:33:25');
...
(1, 'admin', 'admin', '$2y$10$9a9IRj4s5HTy1Z30z8xIFOlC5tLF2.lXews4lhTXuOkBR7G/csmVa', 'admin@gmail.com', 'superadmin', '1', '2024-02-23 07:19:36', '2024-02-25 10:21:58');
...
(1, 'PROFIL MADRASAH ADIWIYATA', NULL, '88etG3cM3PQ', '2024-02-18 23:08:02', '2024-02-18 23:08:02'),
(2, 'PROFIL PERPUSTAKAAN BAIT AL-ILMI MATANSA', NULL, 'ELRUH7Qi82w', '2024-02-18 23:08:13', '2024-02-18 23:08:13');
...
--
ALTER TABLE `tb_foto`
  MODIFY `id_foto` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `tb_kurikulum`
  MODIFY `id_kurikulum` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `tb_rekap_un`
  MODIFY `id_un` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
